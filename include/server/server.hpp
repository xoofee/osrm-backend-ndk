...
class Server
{
  public:
                                    ...
                                    io_context, request_handler, keepalive_timeout))
    {
        ...
        // boost::asio::ip::tcp::resolver::query query(address, port_string);   // boost 1.83 or before
        // boost::asio::ip::tcp::endpoint endpoint = *resolver.resolve(query);
        boost::asio::ip::tcp::resolver::results_type endpoints = resolver.resolve(address, port_string);      // boost 1.87
