...
class CheapRulerContainer
{
  public:
    ...
    {
        // printf(" *** constructor of CheapRulerContainer %d\n", number_of_rulers);
...
void* getCheapRulerContainer() {
    // CheapRulerContainer a(1800);
    // std::cout << " ***  step of local:  " << a.step << std::endl;


    std::cout << " ***  step:  " << cheap_ruler_container.step << std::endl;
    std::cout << " ***  size:  " << cheap_ruler_container.cheap_ruler_cache.size() << std::endl;

    return (void*)&cheap_ruler_container;
}
...
double greatCircleDistance(const Coordinate coordinate_1, const Coordinate coordinate_2)
{
    ...
    // CheapRulerContainer _cheap_ruler_container(1800);
...
double computeAngle(const Coordinate first, const Coordinate second, const Coordinate third)
{
    ...
    double angle = (atan2_lookup(v2y, v2x) - atan2_lookup(v1y, v1x)) * 180. * (1/M_PI);
